      ...
      <div className="flex flex-col gap-y-2 ">
        {AUTOMATION_LISTENERS.map((listener) =>
          listener.type === 'SMARTAI' ? (
            ...
            <div
              ...
              className={cn(
                Listener === listener.type
                  ? 'bg-gradient-to-br w-full from-[#833AB4] via-[#833AB4] via-[#D62976] to-[#3352CC] font-medium text-white'
                  : 'bg-background-80',
                'p-3 rounded-xl flex flex-col gap-y-2 cursor-pointer hover:opacity-80 transition duration-100'
              )}
            >
        ...
        >
          ...
          <Input
            ...
            className="bg-background-80 outline-none border-none ring-0 focus:ring-0"
          />
          <Button className="bg-gradient-to-br w-full from-[#F58529] via-[#D62976] to-[#833AB4] font-medium text-white hover:opacity-80 transition duration-200">
            <Loader state={isPending}>Add Tracker</Loader>
          </Button>
        </form>
      </div>
    </TriggerButton>
